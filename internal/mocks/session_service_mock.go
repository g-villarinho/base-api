...
// GetSessionByToken provides a mock function for the type SessionServiceMock
func (_mock *SessionServiceMock) GetSessionByToken(ctx context.Context, token string) (*domain.Session, error) {
...
// SessionServiceMock_GetSessionByToken_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetSessionByToken'
type SessionServiceMock_GetSessionByToken_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - token string
func (_e *SessionServiceMock_Expecter) GetSessionByToken(ctx interface{}, token interface{}) *SessionServiceMock_GetSessionByToken_Call {
	return &SessionServiceMock_GetSessionByToken_Call{Call: _e.mock.On("GetSessionByToken", ctx, token)}
}

func (_c *SessionServiceMock_GetSessionByToken_Call) Run(run func(ctx context.Context, token string)) *SessionServiceMock_GetSessionByToken_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *SessionServiceMock_GetSessionByToken_Call) Return(session *domain.Session, err error) *SessionServiceMock_GetSessionByToken_Call {
	_c.Call.Return(session, err)
	return _c
}

func (_c *SessionServiceMock_GetSessionByToken_Call) RunAndReturn(run func(ctx context.Context, token string) (*domain.Session, error)) *SessionServiceMock_GetSessionByToken_Call {
	_c.Call.Return(run)
	return _c
}
