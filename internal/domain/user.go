...
var (
	...
	ErrMagicLinkNotEnabled    = errors.New("magic link authentication is not enabled")
	ErrPasswordAuthNotEnabled = errors.New("password authentication is not enabled")
)
...
func NewMagicLinkUser(name, email string) *User {
	return &User{
		ID:        uuid.New(),
		Name:      name,
		Email:     email,
